...
public class TrainingNeuralNetwork {
    ...
    public static void toTrain(Coin company, int initialIndex, int finalIndex, double normalizerValue) {
    ...
    public static double toPredict(Coin company, int finalIndex, double normalizerValue) {
        TechnicalIndicators technicalIndicators = company.getTechnicalIndicators();
