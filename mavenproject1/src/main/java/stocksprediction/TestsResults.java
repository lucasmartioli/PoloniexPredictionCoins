...
public class TestsResults {
    ...
    public static void main(String[] args) {
        ...
        double normalizerValue = getMaxPrice(coin.getTechnicalIndicators());
        indicadorInicial += 36;
...
chartM4.add(new Day(timeSeries.getTick(i - 1).getEndTime().toDate()), coin.getTechnicalIndicators().getSma4days().getValue(i - 1).toDouble());
chartM4.add(new Day(timeSeries.getTick(i - 2).getEndTime().toDate()), coin.getTechnicalIndicators().getSma4days().getValue(i - 2).toDouble());
chartM9.add(new Day(tick.getEndTime().toDate()), coin.getTechnicalIndicators().getSma9days().getValue(i).toDouble());
chartM9.add(new Day(timeSeries.getTick(i - 1).getEndTime().toDate()), coin.getTechnicalIndicators().getSma9days().getValue(i - 1).toDouble());
chartM9.add(new Day(timeSeries.getTick(i - 2).getEndTime().toDate()), coin.getTechnicalIndicators().getSma9days().getValue(i - 2).toDouble());
chartM18.add(new Day(tick.getEndTime().toDate()), coin.getTechnicalIndicators().getSma18days().getValue(i).toDouble());
chartM18.add(new Day(timeSeries.getTick(i - 1).getEndTime().toDate()), coin.getTechnicalIndicators().getSma18days().getValue(i - 1).toDouble());
chartM18.add(new Day(timeSeries.getTick(i - 2).getEndTime().toDate()), coin.getTechnicalIndicators().getSma18days().getValue(i - 2).toDouble());
...
>>>>>>> 0a38c30d9e80c9b0b7f096453b6d8d4efeace262
